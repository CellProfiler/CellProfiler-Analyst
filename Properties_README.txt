...
# ======== Database Info ======== 
# Classifier needs to know how to access your MySQL database.
...
db_passwd  =  <your_password>
	...
	#   The sections below may be used to connect to your data if you are not using 
	#   a MySql database.  Note that they are used in place of the fields above.
	...
	# module. To do this, set db_sql_file to the path to the SETUP.SQL file created
	# by ExportToDatabase. This file must be in the same directory as the CSV files 
	# storing the data. Classifier will use the files to create an SQLite database
	...
	# Not to be confused with db_sql_file, the db_sqlite_file field may be set to
	# the path of a valid SQLite database file containing your per_image and
	# per_object tables.
	#
	# NOTE: You must COMMENT OUT THE FIELDS in the Database Info section and
	#   uncomment the fields below.
	...
	# MySQL database. Classifier will use them to create a SQLite database in your
	# home directory.
	#
	# NOTE: You must COMMENT OUT THE FIELDS in the Database Info section and 
	#  uncomment the fields below.
