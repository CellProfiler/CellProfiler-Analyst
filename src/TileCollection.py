...
class TileCollection(Singleton):
    ...
    def GetTileData(self, obKey, notify_window, priority=1):
        ...
        # if this object is already stored return the image data
        td = self.tileData.get(obKey, None)
        if td:
            return td
        # if the object isn't stored then:
        #   add it to the loadq to be loaded
        #   unlock the TileLoader thread with notify()
