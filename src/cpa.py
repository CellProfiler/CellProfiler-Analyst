...
class MainGUI(wx.Frame):
    ...
    def __init__(self, properties, parent, id=-1, **kwargs):
        ...
        self.histogram_btn.SetPressColor(wx.Color(0,0,0))
        self.density_btn.SetPressColor(wx.Color(0,0,0))
        ...
        tb.AddControl(self.histogram_btn).SetShortHelp('Launch the Histogram Plot tool.')
        tb.AddControl(self.density_btn).SetShortHelp('Launch the Density Plot tool.')
        self.tb.Realize()
...
#        hdlr.setFormatter(logging.Formatter('%(levelname)s | %(name)s | %(message)s [@ %(asctime)s in %(filename)s:%(lineno)d]'))
        ...
        self.Bind(wx.EVT_BUTTON, self.launch_histogram_plot, self.histogram_btn)
        self.Bind(wx.EVT_BUTTON, self.launch_density_plot, self.density_btn)
