...
class MainGUI(wx.Frame):
    ...
    def __init__(self, properties, parent, id=-1, **kwargs):
        ...
        tb.AddLabelTool(ID_CLASSIFIER, 'PixelClassifier', cpa.icons.deeplearning.ConvertToBitmap(), shortHelp='Classifier', longHelp='Launch Classifier')
        ...
        tb.AddLabelTool(ID_COLLECTION_VIEWER, 'CollectionViewer', cpa.icons.image_collection.ConvertToBitmap(), shortHelp='Collection Viewer', longHelp='Launch Image Collection Viewer')
...
##        loadWorkspaceMenuItem = fileMenu.Append(-1, 'Load properties\tCtrl+O', help='Open another properties file.')
        ...
        collectionViewerMenuItem = toolsMenu.Append(ID_COLLECTION_VIEWER, 'Image Collection Viewer\tCtrl+Shift+I', help='Launches the Image Collection Viewer')
